...
var EtheralEmailProvider_1 = __importDefault(require("./MailProvider/implementations/EtheralEmailProvider"));
...
tsyringe_1.container.registerInstance('MailProvider', tsyringe_1.container.resolve(EtheralEmailProvider_1.default));
