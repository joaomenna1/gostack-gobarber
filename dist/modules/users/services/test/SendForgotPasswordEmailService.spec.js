...
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmail = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider, fakeUsersTokensRepository);
    });
    it('should be able recover the password using email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var generateMail, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generateMail = jest.spyOn(fakeUsersTokensRepository, 'generate');
                    return [4 /*yield*/, fakeUsersRepository.create({
                            name: 'John Doe',
                            email: 'john@gmail.com',
                            password: '123456',
