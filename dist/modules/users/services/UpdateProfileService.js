...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, userWithUpdatedEmail, validOldPassword, _b;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (userWithUpdatedEmail && userWithUpdatedEmail.id !== user_id) {
                            throw new AppError_1.default('Email is already taken');
                        }
                        Object.assign(user, { name: name, email: email });
                        if (password && !oldPassword) {
                            throw new AppError_1.default('You need to send the old password to create a new.');
                        }
                        if (!(password && oldPassword)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.hashProvider.compareHash(oldPassword, user.password)];
                    case 3:
                        validOldPassword = _c.sent();
                        if (!validOldPassword) {
                            throw new AppError_1.default('Old password is wrong.');
                        }
                        _b = user;
